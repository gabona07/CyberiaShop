...
class FragmentClothing: Fragment(), MainContract.MainView {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        root = inflater.inflate(R.layout.fragment_clothing, container, false)
        recyclerView = root!!.findViewById(R.id.recycler_view_clothing)
        setupRecyclerView()
        return root
    }
    ...
    private fun setupRecyclerView() {
        ...
        val adapter = ProductAdapter(presenter.getClothingItems())
